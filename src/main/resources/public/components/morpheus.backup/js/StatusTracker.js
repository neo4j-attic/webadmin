morpheus.provide("morpheus.components.backup.StatusTracker");
 ...
 */
morpheus.components.backup.StatusTracker = function(server, manualCb, scheduleCb, interval) {
	...
	me.server = server;
	me.schedule = morpheus.components.backup.Schedule(server);
