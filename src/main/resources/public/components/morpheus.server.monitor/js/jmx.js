 ...
 */
morpheus.components.server.monitor.jmx = (function($, undefined) {
    ...
    me.public = {
            ...
            pageChanged : function(ev) {
                ...
                if(ev.data === "morpheus.server.monitor.jmx") {
                    
                    me.visible = true;
                    
                    if( me.uiLoaded === false ) {
                        me.basePage.setTemplateURL("components/morpheus.server.monitor/templates/jmx.tp");
                    }
...
morpheus.event.bind("morpheus.server.changed",  morpheus.components.server.monitor.jmx.serverChanged);