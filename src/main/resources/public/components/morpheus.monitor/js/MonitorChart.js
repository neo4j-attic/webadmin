morpheus.provide("morpheus.components.monitor.MonitorChart");

//$.require("js/vend/jquery.flot.js");

morpheus.components.monitor.monitorCharts = 0;
 ...
 */
morpheus.components.monitor.MonitorChart = function(server, settings) {
	...
	me.server = server;
	me.containerId = "mor_monitor_chart_" + morpheus.components.monitor.monitorCharts++;
