        ...
        for (var i=0; i<this._series.length; i++) {
            ...
            for (var j=0; j<d.length; j++) { 
                if (this.name == 'xaxis' || this.name == 'x2axis') {
                    d[j][0] = new Date(d[j][0]).getTime();
                    pd[j][0] = new Date(d[j][0]).getTime();
                    sd[j][0] = new Date(d[j][0]).getTime();
                    ...
                    d[j][1] = new Date(d[j][1]).getTime();
                    pd[j][1] = new Date(d[j][1]).getTime();
                    sd[j][1] = new Date(d[j][1]).getTime();
