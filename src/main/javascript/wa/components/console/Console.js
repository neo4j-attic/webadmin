...
wa.ui.Pages.add("morpheus.console",wa.components.console.Console);
wa.ui.MainMenu.add({ label : "Console", pageKey:"morpheus.console", index:2, requiredServices:['console'], perspectives:['server']});
